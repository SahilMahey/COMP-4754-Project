...
function HomePage() {
    const [movies, setMovies] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        {
            ...
            year: 2010,
            description: "A skilled thief steals valuable secrets from the subconscious during the dream state."
        },
        {
            id: 2,
            ...
            year: 2008,
            description: "When the menace known as the Joker emerges, he wreaks havoc on Gotham."
        },
        {
            id: 3,
            title: "Interstellar",
    ...
    const [isLoggedIn, setIsLoggedIn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(localStorage.getItem("isLoggedIn") === "true");
    ...
    const handleBookmarkClick = (movie)=>{
        ...
        setBookmarks((prev)=>prev.find((item)=>item.id === movie.id) ? prev.filter((item)=>item.id !== movie.id) // Remove if already bookmarked
             : [
                ...prev,
                movie
    ...
    const handleDetailsClick = (movie)=>{
        setSelectedMovie(movie); // Open modal with selected movie
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__170bce._.js.map